        ...
        >
          <div style={{ textAlign: "center", padding: '0px 6px' }}>
            <svg width="50" height="61" viewBox="0 0 60 61" fill="none" style={{margin: "0 0 10px 0"}} xmlns="http://www.w3.org/2000/svg">
              <path d="M29.6448 4.18053L23.7949 1V13.6653L29.6448 15.7099L35.5231 13.6653V1L29.6448 4.18053Z" fill="#3A36DB" stroke="#3A36DB" stroke-width="0.0567951" />
              <path d="M29.6166 14.6023L9 4.29395V17.0445L29.6166 27.8923L51 17.0445V4.29395L29.6166 14.6023Z" fill="#3A36DB" stroke="#3A36DB" stroke-width="0.0567951" />
              <path d="M29.9865 8.83785L17.0088 2.3916V14.5458L29.9865 20.9352L42.5098 14.1482V2.3916L29.9865 8.83785Z" fill="#3A36DB" stroke="#3A36DB" stroke-width="0.0567951" />
